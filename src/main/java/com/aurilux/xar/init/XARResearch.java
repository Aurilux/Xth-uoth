...
import com.aurilux.xar.research.XARResearchItem;
...
public class XARResearch {
    private static final String CATEGORY = "XTHUOTH";
    private static HashMap<String, Object> recipes = new HashMap<String, Object>();

    public static void init() {
        ResearchCategories.registerCategory(CATEGORY, ResourceUtils.getResource(ResourceUtils.GUI + "swirl.png"),
            ResourceUtils.CATEG_BG_ELDRITCH);
        ...
        new XARResearchItem("mixingPotions", CATEGORY,
            new AspectList(),
            1, -2, 3, new ItemStack(XARBlocks.immixer, 1, 0))
        ...
        new XARResearchItem("prysmal", CATEGORY,
            new AspectList(),
            1, 0, 0, new ItemStack(XARBlocks.orePrysmal))
            .setAutoUnlock().setRound()
            .registerResearchItem()
        ...
        new XARResearchItem("shardInfusion", CATEGORY,
            ...
            3, -2, 0, new ItemStack(XARItems.prysmalShard, 1))
        ...
        new XARResearchItem("prysmalWandCaps", CATEGORY,
            ...
            3, 0, 0, new ItemStack(XARItems.itemWandCap))
        ...
        new XARResearchItem("prysmalArmor", CATEGORY,
            ...
            3, 2, 0, new ItemStack(XARItems.prysmalChest))
        ...
        new XARResearchItem("rifts", CATEGORY,
            new AspectList(),
            -1, 0, 0, ResourceUtils.RIFT_TEXTURE)
            .setAutoUnlock().setRound()
            .registerResearchItem()
        ...
        new XARResearchItem("aberrations", CATEGORY,
            new AspectList(),
            -3, 2, 0, new ItemStack(XARBlocks.aberrack))
