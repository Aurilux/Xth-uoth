...
public class XARPotions {
	...
	public static void init() {
        ...
        //new array with the appropriate size, copying the original contents, and then use reflection to set the
        ...
        HashMap myPotionRequirements = ReflectionUtils.getProtectedValue(PotionHelper.class, "potionRequirements", "field_77927_l");
