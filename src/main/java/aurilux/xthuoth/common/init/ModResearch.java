...
import aurilux.xthuoth.common.research.XARResearchItem;
...
public class ModResearch {
    ...
    public static void init() {
        ResearchCategories.registerCategory(CATEGORY, Xthuoth.assets.getGuiRes("swirl.png"),
        ...
        new XARResearchItem("rifts", CATEGORY,
            new AspectList(),
            -1, 0, 0, Xthuoth.assets.getEntityRes("rift2.png"))
            .setAutoUnlock().setRound()
            .registerResearchItem()
        ...
        new XARResearchItem("aberrations", CATEGORY,
            new AspectList(),
            -3, 2, 0, new ItemStack(ModBlocks.blockAberrack))
