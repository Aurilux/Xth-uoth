...
import aurilux.xthuoth.common.init.ModWorldgen;
import aurilux.xthuoth.common.render.SkyRendererXthuoth;
...
public class WorldProviderXthuoth extends WorldProvider {
    ...
    public void registerWorldChunkManager() {
        this.worldChunkMgr = new ChunkManagerXthuoth(ModWorldgen.aberrantBiome, 0.0f, 0.0f);
